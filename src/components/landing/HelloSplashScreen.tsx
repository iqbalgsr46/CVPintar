...
export default function HelloSplashScreen({ onComplete }: { onComplete: () => void }) {
  useEffect(() => {
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        // Soft pastel gradient matching the user's reference image
        background: "linear-gradient(135deg, #fbcfe8 0%, #ede9fe 50%, #cffafe 100%)",
        overflow: "hidden"
      }}
    >
      <div style={{ width: "80%", maxWidth: "600px", display: "flex", justifyContent: "center" }}>
        <motion.svg 
          viewBox="-109 -9 2504 746" 
